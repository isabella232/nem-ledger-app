...
07. Devariant path (44/43/0/0/0)   (20 bytes) (8000002C800010F7800000008000000080000000) (fixed)
08. Transaction Type               (8 bytes)  (depends on tx) (01010000)
...
messageFieldLength                                   uint32                                          Size of the attached message
MessageType  (Not exist if messageFieldLength = 0)   uint32 	                                     MessageType
LengthOfPayload(Not exist if messageFieldLength = 0) uint32 	                                     Reserved padding to align mosaics on 8-byte boundary.
Payload (Not exist if messageFieldLength = 0)        array(messageSize)                              Message type and hexadecimal payload.
