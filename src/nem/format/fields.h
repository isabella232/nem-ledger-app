...
#define NEM_UINT16_TRANSACTION_TYPE 0x30
#define NEM_UINT16_INNER_TRANSACTION_TYPE 0x31
...
#define NEM_HASH256_AGG_HASH 0xB0
#define NEM_HASH256_HL_HASH 0xB1

#define NEM_MOSAICT_HL_QUANTITY 0xD0
#define NEM_MOSAICT_AMOUNT 0xD1
